...
abstract class REST_Controller extends CI_Controller
{
    ...
    public function __construct($config = 'rest')
    {
       ...
       // $this->load->model(array('WebServiceModel'));
        ...
        $ignoreMethods = array('getAccountDetailsListing','addEditAccountDetails','addEditState','getStateListing','deleteState',
			'addEditCity','getCityListing','deleteCity','addEditCountry','getCountryListing','deleteCountry',
			'deleteAccountDetails', 'getEmployeeListing','addEditEmployee', 'deleteEmployee', 'getEmployeeLeaveListing',
			'addEditEmployeeLeave','deleteEmployeeLeave','getDepartmentListing','addEditDepartment','deleteDepartment',
			'getRoleListing','addEditRole','deleteRole','getCompanyListing','addEditCompany','deleteCompany',
			'getSalaryListing','addEditSalary','deleteSalary','getWorkWeekListing','addEditWorkWeek','deleteWorkWeek',
			'getGenderListing','addEditGender','deleteGender','getMaritalStatusListing','addEditMaritalStatus','deleteMaritalStatus'
			,'getLeaveTypeListing','addEditLeaveType','deleteLeaveType');
