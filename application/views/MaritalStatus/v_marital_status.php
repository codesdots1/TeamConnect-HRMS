<div class="quicklink-sidebar-menu ctm-border-radius shadow-sm grow bg-white card">
	<div class="card-body">
		<ul class="list-group list-group-horizontal-lg">
			<li class="list-group-item text-center active button-5"><a class="text-white"><?= lang('marital_status_index_heading') ?></a></li>
			<li class="list-group-item text-center button-6"><a class="text-dark" href="<?= site_url('Gender'); ?>"><?= lang('gender_index_heading') ?></a></li>
		</ul>
	</div>
</div>
...
<div class="card shadow-sm grow ctm-border-radius">
	<div class="card-body align-center">
		<h4 class="card-title float-left mb-0 mt-2"><b><?= lang('marital_status_index_heading') ?></b></h4>
            ...
            "columns": [
                ...
                {"data": "marital_status"},
                {
                    ...
                    "render": function (data, type, row) {
                        ...
                        html += "<a  href='<?= site_url('MaritalStatus/manage/'); ?>" + id + "' data-popup='custom-tooltip' data-original-title='<?= lang('edit_marital_status') ?>'  onclick='EditRecord(" + id + ")' title='<?= lang('edit_marital_status') ?>' class='btn btn-outline-warning btn-sm mr-1'><i class='fa fa-pencil'></i></a>";
                        html += "&nbsp";
                        html += "<a href='javascript:void(0);' onclick='DeleteRecord(" + id + ")' data-popup='custom-tooltip' data-original-title='<?= lang('delete_marital_status') ?>' title='<?= lang('delete_marital_status') ?>'  class='btn btn-outline-danger btn-sm mr-1' ><i class='fa fa-trash'></i></a>";
                        return html;
                    },
                    "sortable": false,
                    "searchable": false
