<div class="panel panel-flat border-left-lg border-left-slate">
	<div class="panel-heading ">
		<h5 class="panel-title"><?= lang('view_project') ?><a class="heading-elements-toggle"><i class="icon-more"></i></a>
		</h5>
	...
	<div class="panel-body">
		...
		<div class="tabbable">
			<div class="tab-content">
				<legend><b> <i class="icon-rulers"></i> <?= lang('view_project') ?> </b> </legend>

				<div class="form-group">
					<b><label class="col-lg-3 control-label"><?= lang('project_name') ?> : </label></b>
					<div class="col-lg-9">
						<?= (isset($getProjectData['project_name']) && ($getProjectData['project_name']!= '')) ? $getProjectData['project_name'] : ''; ?>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-lg-9">
						<?php
							if($getProjectData['description'] == ''){
								echo "No Description Added";
							}?>
						<?= (isset($getProjectData['description']) && ($getProjectData['description']!= '')) ? $getProjectData['description'] : ''; ?>
					</div>
				</div>
		...
		<div class="text-right">
			<button type="button" class="btn btn-xs border-slate text-slate btn-flat cancel"
					onclick="window.location.href='<?php echo site_url('Project'); ?>'"><?= lang('back_btn') ?> <i class="icon-cross2 position-right"></i> </button>
