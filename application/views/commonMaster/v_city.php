<div class="quicklink-sidebar-menu ctm-border-radius shadow-sm grow bg-white card">
	<div class="card-body">
		<ul class="list-group list-group-horizontal-lg">
			<li class="list-group-item text-center active button-5"><a class="text-white"><?= lang('city_heading') ?></a></li>
...
<div class="card shadow-sm grow ctm-border-radius">
	<div class="card-body align-center">
		<h3 class="card-title float-left mb-0 mt-2">4530 City</h3>
		<ul class="nav nav-tabs float-right border-0 tab-list-emp">
			...
			<li class="nav-item pl-3">
				<a class="btn btn-theme button-1 text-white ctm-border-radius p-2 add-person ctm-btn-padding addCity"><i
							class="fa fa-plus"></i> <?= lang('add_city') ?></a>
			</li>
            ...
            "columns": [
				...
				},
                {
                    ...
                    "render": function (data, type, row) {
                        var html = '';
                        var id = row['city_id'];
                        html += "<button value='"+id+"' data-popup='custom-tooltip' data-original-title='<?= lang('edit_city') ?>' title='<?= lang('edit_city') ?>' class='btn btn-outline-warning btn-sm mr-1 editRecord'  ><i class='fa fa-pencil'></i></button>";
                        html += "&nbsp";
                        html += "<a href='javascript:void(0);' data-popup='custom-tooltip' data-original-title='<?= lang('delete_city') ?>' onclick='DeleteRecord(" + id + ")' title='<?= lang('delete_city') ?>'  class='btn btn-outline-danger btn-sm mr-1' ><i class='fa fa-trash'></i></a>";
                        return html;
                    },
                    "sortable": false,
                    "searchable": false
