                    ...
                    foreach ($languages as $languageCount => $languageData) {
                        ...
                        <div role="tabpanel" class="<?= ($languageCount == 0) ? "tab-pane active" : "tab-pane"; ?>"
                            ...
                            <input type="hidden" name="language_id[]"
                                   ...
                                   id="">
                            <input type="hidden" name="marital_status_description_id[]"
                                   value="<?= (isset($getMaritalStatusDescription[$languageData['language_id']]['marital_status_description_id']) && ($getMaritalStatusDescription[$languageData['language_id']]['marital_status_description_id'] != '')) ? $getMaritalStatusDescription[$languageData['language_id']]['marital_status_description_id'] : ''; ?>"
                                   id="marital_status_description_id">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" name="marital_status[]" id="marital_status" class="form-control"
                                           value="<?= (isset($getMaritalStatusDescription[$languageData['language_id']]['marital_status']) && ($getMaritalStatusDescription[$languageData['language_id']]['marital_status'] != '')) ? $getMaritalStatusDescription[$languageData['language_id']]['marital_status'] : ''; ?>"
