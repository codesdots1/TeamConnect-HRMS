...
$(function () {
    ...
    $('.daterange-ranges').daterangepicker(
        ...
        function (start, end) {
          ...
          //  $("#created_at_start_date").val(start.format('YYYY/MM/D'));
            //$("#created_at_end_date").val(end.format('YYYY/MM/D'));
    ...
    // $("#created_at_start_date").val(moment().subtract(29, 'days').format('YYYY/MM/D'));
    // $("#created_at_end_date").val(moment().format('YYYY/MM/D'));
